  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Ja. Wir bieten einen dedizierten Grundkurs Botulinum für Zahnärzt:innen. Im Mittelpunkt steht die zahnärztlich relevante Indikation am Masseter, insbesondere bei Bruxismus. Darüber hinaus gibt Dir der Onlinekurs Einblick in weitere Anwendungsgebiete wie Glabella, Stirn und Migräne, damit Du die Wirkung von Botulinum ganzheitlich verstehst. Der Kurs richtet sich ausschließlich an approbierte Zahnärzt:innen und berücksichtigt die berufsrechtlichen Rahmenbedingungen in Deutschland.",
      },
      {
