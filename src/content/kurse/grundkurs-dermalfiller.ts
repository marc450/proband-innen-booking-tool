...
export const grundkursDermalfiller: CourseLandingContent = {
  ...
  hero: {
    ...
    stats: [
      ...
      { icon: "Award", label: "Akkreditiert", value: "18 CME-Punkte + Zertifikat" },
    ...
    // object-position X shifts the visible crop so the subject appears
    // further to the right within the frame.
    videoObjectPosition: "35% center",
  },
  ...
  lernplattform: {
    ...
    features: [
      ...
      },
      {
        ...
        mediaPath: "https://hqjgugcehqfeempxvwkd.supabase.co/storage/v1/object/public/marketing-assets/grundkurs_dermalfiller/My%20Movie-compressed.mp4",
      },
      {
